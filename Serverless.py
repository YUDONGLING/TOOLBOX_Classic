            ...
            def _ZxincApi():
                ...
                try:
                    ...
                    if '中国' in Location:
                        ...
                        Location = Location.replace('中国电信', '电信').replace('中国联通', '联通').replace('中国移动', '移动').replace('中国铁通', '铁通').replace('中国教育网', '教育网').replace('中国教育和科研计算机网 (CERNET)', '教育网').removesuffix('无线基站网络')
