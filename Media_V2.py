...
def addText(fileFolder, fileName, writeData, fontPath = None, fontSize = 0.0375, fontColor = (255, 255, 255), BGColor = (0, 0, 0, 128)):
    ...
    if fontPath:
        try:
            ...
            defaultFontPath = "C:/Windows/Fonts/simfang.ttf" # Windows 系统路径
...
def getInfo_Online(Type, URL, customHeader = None):
    import cv2
    import numpy
    import requests
    ...
    try:
        if Type == "IMAGE":
            _, headInfo = Pkg_Download_headURL(URL, customHeader = customHeader)
